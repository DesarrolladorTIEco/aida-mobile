...
class GeneralGalleryPage extends StatefulWidget {
  const GeneralGalleryPage({super.key});

  @override
  _GeneralGalleryPageState createState() => _GeneralGalleryPageState();
}

class _GeneralGalleryPageState extends State<GeneralGalleryPage> {
  ...
  Future<void> _loadImagesFromAPI() async {
    final url = Uri.parse('${_apiService.baseUrl}securitic/get-all-images');

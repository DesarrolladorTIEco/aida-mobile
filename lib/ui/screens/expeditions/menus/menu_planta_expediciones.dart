...
class MenuExpedicionesScreen extends StatefulWidget {
  const MenuExpedicionesScreen({Key? key}) : super(key: key);

  @override
  State<MenuExpedicionesScreen> createState() => _MenuExpedicionesState();
}

class _MenuExpedicionesState extends State<MenuExpedicionesScreen> {
  @override
  void initState() {
    super.initState();
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      Navigator.pushNamed(context, '/zone-expediciones', arguments: selectedZoneName,);
                    },
                    child: Card(
